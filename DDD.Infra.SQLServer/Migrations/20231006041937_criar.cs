    ...
    public partial class criar : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participacaos", x => x.ParticipacaoId);
                    table.ForeignKey(
                        name: "FK_Participacaos_Aluno_AlunoId",
                        column: x => x.AlunoId,
                        principalTable: "Aluno",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Participacaos_Eventos_EventoId",
                        column: x => x.EventoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TutorEventoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TutorEventos", x => x.TutorEventoId);
                    table.ForeignKey(
                        name: "FK_TutorEventos_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "EventoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TutorEventos_Tutors_TutorId",
                        column: x => x.TutorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participacaos_AlunoId",
                table: "Participacaos",
                column: "AlunoId");

            migrationBuilder.CreateIndex(
                name: "IX_Participacaos_EventoId",
                table: "Participacaos",
                column: "EventoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorEventos_EventoId",
                table: "TutorEventos",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_TutorEventos_TutorId",
                table: "TutorEventos",
                column: "TutorId");
        }
